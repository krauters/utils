...
describe('Arrays', () => {
  describe('average', () => {
    ...
    it('should return the floored average', () => {
      expect(Arrays.average([1, 2, 3])).toBe(2) // (1+2+3)/3 = 2
      expect(Arrays.average([1, 2, 4])).toBe(2) // (1+2+4)/3 = 2.333... floored to 2
    })
  })
  ...
  describe('range', () => {
    it('should generate a range of numbers with default step', () => {
      ...
      const result = Array.from(generator).slice(0, 4) // Prevent infinite loop
    ...
    it('should generate a range of numbers with positive step', () => {
      ...
      const result = Array.from(generator).slice(0, 5) // Prevent infinite loop
